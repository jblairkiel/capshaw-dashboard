...
router.post('/generate-questions', requireApproved, async (req, res) => {
  const {
    passage,
    gradeLevel,
    questionCount = 10,
...
router.post('/questions/save', requireApproved, (req, res) => {
...
router.delete('/questions/set/:id', requireApproved, (req, res) => {
